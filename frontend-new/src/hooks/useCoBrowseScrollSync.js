import { useEnhancedScrollSync } from "./useEnhancedScrollSync"

/**
 * Wrapper hook for co-browse scroll sync
 * Maintains backward compatibility with existing code
 */
export function useCoBrowseScrollSync(userType, enabled = true, containerId = "default") {
  const { scrollRef, attach, isLeader, syncStatus, setLeader, setContainerReady } = useEnhancedScrollSync({
    containerId,
    userType,
    enabled,
  })
